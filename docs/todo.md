1. review app strings, like settings explaining too much
2. clean git commit history, delete old releases, tags, and PRs
3. make repo public and configure permissions
4. verify auto-update end to end — `electron-updater` reads releases anonymously, so every check
